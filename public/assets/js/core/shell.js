...
const groups=[
  ['OPERATIONS',[['conversations','Conversations'],['case-management','Case Management']]],
  ...
  ['SYSTEM',[['ai-settings','AI Settings'],['learning','Learning'],['logs','Logs'],['health','Health'],['security','Security']]]
];
const iconMap={conversations:'◫','case-management':'◇',knowledge:'▤','ai-rules':'⌘',responses:'≡','menu-penting':'★','bekal-bot':'◆','canned-responses':'#','telegram-cta':'↗','telegram-settings':'✦','website-profile':'◎','ai-settings':'⚙',learning:'↻',logs:'☷',health:'♥',security:'⌾'};
export async function mountShell(){
  ...
  document.body.innerHTML=`<div class="app-shell"><aside class="sidebar"><div class="brand"><div class="brand-mark">LA</div><div class="brand-copy"><b>LIVECHAT AI</b><small>Operations Console</small></div><button class="sidebar-collapse" id="sidebarCollapse" title="Compact sidebar">‹</button></div><nav class="nav">${nav}</nav><div class="sidebar-foot"><span class="status-dot"></span><span>Production</span></div></aside><section class="workspace"><header class="topbar"><div class="topbar-left"><button class="icon-btn mobile-menu" id="mobileMenu">☰</button><div><div class="topbar-title">${document.title}</div><div class="topbar-sub">Customer Operations Control Center</div></div></div><div class="topbar-right"><div class="system-chip" id="healthChip"><i></i><span>System</span></div><div class="system-chip" id="aiChip"><i></i><span>AI</span></div><div class="system-chip" id="telegramChip"><i></i><span>Telegram</span></div><span class="user-chip">${me.user||'admin'}</span><button class="btn ghost" id="logoutBtn">Keluar</button></div></header><main class="page" id="shellContent"></main></section></div><div class="sidebar-backdrop" id="sidebarBackdrop"></div>`;
